  ...
  return (
    <main className="flex flex-col items-center gap-10 min-h-screen font-gabarito px-4">
      ...
      <section className="py-20 px-4 max-w-4xl mx-auto font-gabarito text-pink-300">
        {/* --- Category: Soft Serve --- */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold mb-8">🍦 Soft Serve</h2>
        ...
        {/* --- Category: Scoops --- */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold mb-8">🍨 Scoops</h2>
          <div className="space-y-6">
            <div>
        ...
        {/* --- Category: Ice Pops --- */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold mb-8">🍡 Ice Pops</h2>
          <div className="space-y-6">
            <div>
